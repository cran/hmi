...
library("mice")
library("hmi")
#source('C:/Users/Matthias/Documents/hmi/R/hmi_wrapper_2017-12-20.R')
...
library("hmi")
#source('C:/Users/Matthias/Documents/hmi/R/hmi_imp_cont_multi_2017-10-25.R')
#source('C:/Users/Matthias/Documents/hmi/R/hmi_smallfunctions_2017-12-28.R')
ex
set.seed(1)
result_multi <- hmi(data = ex, model_formula = Reaction ~ 1 + Days + (1 + Days | Subject), maxit = 1)
