...
library("mice")
library("hmi")
#source('C:/Users/Matthias/Documents/hmi/R/hmi_wrapper_2017-08-24.R')
...
library("lme4")
lmer(Reaction ~ 1 + Days + (1 + Days | Subject), data = ex)
...
library("hmi")
#source('C:/Users/Matthias/Documents/hmi/R/hmi_imp_cont_multi_2017-09-03.R')
#source('C:/Users/Matthias/Documents/hmi/R/hmi_smallfunctions_2017-09-14.R')
ex
set.seed(1)
result_multi <- hmi(data = ex, model_formula = Reaction ~ 1 + Days + (1 + Days | Subject), maxit = 1)
